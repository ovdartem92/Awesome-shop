...
public class LogInTest extends BaseTest {
    ...
    public void logInWithValidDataTest() {
        ...
        Assert.assertTrue(AbstractScreen.HEADER_SCREEN.isAccountButtonDisplayed(), "The account button is not active. Verification failed and you are not logged in. Incorrect data may have been entered");
    }

    @Test(description = "check login with invalid data")
    public void logInWithInValidDataTest() {
        ACCOUNT_SERVICE.logIn(UserBuilder.getUserWithInvalidPassword());
        Assert.assertTrue(AbstractScreen.HEADER_SCREEN.isLoginButtonDisplayed(), "The login button is not active. You may have entered the correct data and logged in");
    }
}
