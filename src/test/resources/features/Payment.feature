Feature: Payment
  ...
  Scenario: add payment address
    ...
    Then I get success message: "Success: Payment address has been set!"
  ...
  Scenario: set payment method
    ...
    Then I get status cod 200
    Then I get success message: "Success: Payment method has been set"

  @payment @positive @api
  Scenario: get payments methods
    When I perform request to get payment method
    Then I get status cod 200
    Then I get error message: "Warning: No Payment options are available!"
