...
public class CarsSearchResultsPage extends AbstractScreen {
    ...
    private static final String BANNER_ALERT_MESSAGE_LOCATOR = "//*[contains(@class,'BpkBannerAlert_bpk-banner-alert__message')][contains(text(),'%s')]";
    private static final String CAR_SEARCH_SUMMARY_ROUTE_LOCATOR = "//div[@id='carhire-search-summary-route']";
    private static final String CAR_GROUP_PANEL_INFO_SUMMARY_LOCATOR = "//div[contains(@class, 'CarGroupPanel_car-info')]";
    ...
    public boolean isAgeAlertVisible() {
        return WaitManager.isElementVisible(String.format(BANNER_ALERT_MESSAGE_LOCATOR, AGE_MESSAGE_TEXT), Browser.DEFAULT_TIMEOUT_SECONDS);
    }
