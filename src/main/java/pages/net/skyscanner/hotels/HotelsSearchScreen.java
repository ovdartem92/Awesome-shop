...
public class HotelsSearchScreen extends AbstractScreen {
    ...
    public HotelsSearchScreen clickMaxIncreaseFilterButton(FilterButtonsId id) {
        String locator = getLocatorForFilterButton(id);
    ...
    private String getLocatorForFilterButton(FilterButtonsId id) {
        return String.format(BUTTON_LOCATOR, id.toString().toLowerCase(), "Increase");
    }
