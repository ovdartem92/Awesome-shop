...
public class HotelsResultScreen extends AbstractScreen {
    ...
    private static final String HOTEL_PRICE_LOCATOR = ".//div[3]//div[contains(@class, 'HotelCard_HotelCard__price')]";
    ...
    private static void isWaitingModalInvisible() {
        isElementInvisible(WAITING_MODAL_VIEW, LONG_TIMEOUT_SECONDS);
    }
