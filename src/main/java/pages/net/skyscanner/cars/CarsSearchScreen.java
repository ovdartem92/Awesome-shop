...
public class CarsSearchScreen extends AbstractScreen {
    ...
    private static final String SEARCH_BUTTON_PATH = "//button[@id='carhire-search-controls-search-button']";
    ...
    public CarsSearchResultsScreen clickSearchButton() {
        Browser.getDriver().findElement(By.xpath(SEARCH_BUTTON_PATH)).click();
