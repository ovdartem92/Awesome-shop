...
public class CarsSearchResultsScreen extends AbstractScreen {
    ...
    private static final String BANNER_ALERT_MESSAGE_LOCATOR = "//*[contains" +
            "(@class,'BpkBannerAlert_bpk-banner-alert__message')][contains(text(),'%s')]";
    private static final String CAR_SEARCH_SUMMARY_ROUTE_LOCATOR = "//div[@id='carhire-search-summary-route']";
    private static final String CAR_GROUP_PANEL_INFO_SUMMARY_LOCATOR = "//div[contains(@class," +
            " 'CarGroupPanel_car-info')]";
    private static final String CAR_CHECKBOX_LOCATOR = "//div[@id='car-%s']//input[@type='checkbox'" +
            " and @aria-label='%s']";
