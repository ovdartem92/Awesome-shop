...
public class CarsSearchResultsScreen extends AbstractScreen {
    ...
    private static final String AGE_MESSAGE = "Driver aged under 25";
    private static final String BANNER_ALERT_MESSAGE = "//*[contains(@class,'BpkBannerAlert_bpk-banner-alert__message')][contains(text(),'%s')]";
