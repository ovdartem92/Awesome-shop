...
public final class ContactInfoFactory {
    ...
    public static ContactInfo generateValidContactInfo() {
        return new ContactInfo(TELEPHONE_NUMBER, FAX_NUMBER, AddressFactory.generateValidAddress());
    }
    ...
    public static ContactInfo generateContactInfoWithInvalidTelephone() {
        ...
        return new ContactInfo(invalidTelephone, FAX_NUMBER, AddressFactory.generateValidAddress());
    }

    public static ContactInfo generateContactInfoWithEmptyTelephone() {
        return new ContactInfo("", FAX_NUMBER, AddressFactory.generateValidAddress());
    }

    public static ContactInfo generateContactInfoWithEmptyFax() {
        return new ContactInfo(TELEPHONE_NUMBER, "", AddressFactory.generateValidAddress());
    }
