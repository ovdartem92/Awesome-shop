...
public class SkyScannerCarSearchPage extends AbstractPage {
    ...
    private static final String RETURN_CAR_TO_A_DIFFERENT_LOCATION_CHECKBOX_PATH = "//div[contains(@class,'margin-bottom')]//input[@type='checkbox']']";
    private static final String DATE_PICKUP_PATH = "//input[@id='carhire-search-controls-date-pick-up']";
    private static final String DATE_PICKUP_MONTH_FIELD_PATH = "//select[contains(@id,'calendar_nav_select')]";
    private static final String DATE_PICKUP_MONTH_PATH = "//select[contains(@id,'calendar_nav_select')]/option[text()='October 2020']";
